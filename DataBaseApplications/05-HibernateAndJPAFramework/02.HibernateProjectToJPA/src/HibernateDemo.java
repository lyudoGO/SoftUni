/*Problem 2.	Migrate Old Hibernate Project to JPA
You are given an old-style Hibernate project (based on XML mappings, without annotations), 
the first example from the Hibernate demo projects, holding the University database:
Your task is to migrate it to JPA with annotated Java classes.
You are not allowed to use the native Hibernate APIs.*/
