...
var circleNew = new Circle(20, 30, "#fffddd", 1.5);
console.log(circleNew.toString() + "\n");
//console.log(circleNew.setRadius());
var rectNew = new Rectangle(10, 10, "#123456", 12, 21);
console.log(rectNew.toString() + "\n");

var tringleNew = new Triangle(10, 20, "#AAADDD", 23, 23, 34, 34);
console.log(tringleNew.toString() + "\n");

var segmentNew = new Segment(35, 45, "#ADFADF", 65, 120);
console.log(segmentNew.toString() + "\n");

var pointNew = new Point(45, 56, "#DFDFDD");
console.log(pointNew.toString() + "\n");